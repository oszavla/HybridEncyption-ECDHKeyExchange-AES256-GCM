# --- Image Processing: binary to image for Decrypted text Visualization ---

# input decrypted_binary.txt
# input lebar, tinggi (from original image)
# output gambar 'decrypted_image.png'
...
input_decrypted_binary_path = r"C:\Users\ASUS\CompPhyPy\Data_Komputasi\Cryptography_Final_Project\decrypted_binary.txt"
output_decrypted_image_path = r"C:\Users\ASUS\CompPhyPy\Data_Komputasi\Cryptography_Final_Project\decrypted_image.png"
    ...
    for y in range(height):
        for x in range(width):
            ...
            if end <= len(binary_data_str):
                ...
                # If decrypted text is shorter than expected image data, fill remaining with black
                image[y, x] = [0, 0, 0]
...
binary_to_img_for_visual(input_decrypted_binary_path, output_decrypted_image_path, lebar, tinggi)